...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { lista: @sala.lista, nome: @sala.nome, prioridade: @sala.prioridade, tipo: @sala.tipo } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { lista: @sala.lista, nome: @sala.nome, prioridade: @sala.prioridade, tipo: @sala.tipo } }
